...
`: "";
            fileContent += filteredArray[0] === 'model' ? `export interface ${filteredArray[1]} {`: `enum ${filteredArray[1]} {`;
  ...
  ${filteredArray[0]} = '${filteredArray[0]}',`;
                    ...
                    const type = types[filteredArray[1].replace('?', '')] ? types[filteredArray[1].replace('?', '')] : filteredArray[1].replace('?', '');
                    fileContent += `
